...
if __name__ == "__main__":
    ...
    # Example queries
    query_index(collection, "What triggers InterfaceHeartbeat in Radius Filler?")
    #query_index(collection, "How do you Update a single tag with single value using static key matching?")
